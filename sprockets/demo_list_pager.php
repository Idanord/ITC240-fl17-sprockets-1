...
require 'includes/Pager.php'; #allows pagination //this needs to be added to my list/view
# SQL statement
$sql = "select * from test_Customers";

#Fills <title> tag  
$title = 'Customer List/View/Pager';
$config->loadhead .= '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">'; //this needs to be added to my list/view
...
$prev = '<i class="fa fa-chevron-circle-left"></i>'; //this needs to be added to my list/view
$next = '<i class="fa fa-chevron-circle-right"></i>'; //this needs to be added to my list/view
...
$myPager = new Pager(2,'',$prev,$next,''); //this needs to be added to my list/view
$sql = $myPager->loadSQL($sql,$iConn);  #load SQL, pass in existing connection, add offset  //this needs to be added to my list/view
$result = mysqli_query($iConn,$sql) or die(myerror(__FILE__,__LINE__,mysqli_error($iConn)));

if(mysqli_num_rows($result) > 0)
{#records exist - process
    echo $myPager->showNAV();//show pager if enough records         //this needs to be added to my list/view
	if($myPager->showTotal()==1){$itemz = "customer";}else{$itemz = "customers";}  //deal with plural      //this needs to be added to my list/view
    echo '<p align="center">We have ' . $myPager->showTotal() . ' ' . $itemz . '!</p>';                     //this needs to be added to my list/view
